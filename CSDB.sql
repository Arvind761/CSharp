Use Master
 ...
 Create table Emp
 (Empno Int Constraint Empno_Pk Primary Key, Ename Varchar(100), Job Varchar(100), Mgr Int, 
HireDate Date, Salary Money, Comm Money, Deptno Int References Dept(Deptno))
